...
Keys have attributes that are set at creation-time and restrict how
they may be used. Attributes include \verb|FixedTPM| to control
duplication, \verb|Sign| and \verb|Decrypt| to indicate use as a
signing or decryption key, and \verb|Restricted| to limit operations 
to TPM-generated data. 
