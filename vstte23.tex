...
\begin{abstract}
  ...
  calls into question the integrity of trust decisions.  We developed
  and verified two models of TCG provisioning protocols resulting in
  assurance that secure identifiers are created from a properly
  provisioned TPM.  As a result we can be assured that device
...
request.  Certificate request production is described in
Figure~\ref{fig:constrain-csr-production}. The certificate-requesting
