...
certificate-requesting entity. The specification claims that each
protocol provides for certain assurances. Each assurance manifests as
...
specific \emph{device} of that type.
...
proposed modification is it requires a large database of golden hash
values. It may prove unrealistic to implement this change in
circumstances where a precise device identity is not required and
their are a large number of devices. However, the approach may still
be useful in critical systems where it is imperative to know the
identity of a specific device.
%
%
%
