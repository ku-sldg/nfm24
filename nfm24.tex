...
the identity must be: (i) generated and bound to the device using good
credentials; and (ii) stored in a way that prevents use by other
devices.  Without strong identification a malicious source can spoof
...
device's TPM when used. These protocols are performed by a trusted
