\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=2.0cm,
  ...
  \node[key] (EK) {EK};
  \node[key] (IAK) [node distance=1.5cm, below of=EK] {IAK};
  \node[key] (IDevID) [node distance=2.5cm, right of=IAK] {IDevID};
  \node[key] (LDevID) [node distance=1.5cm, below of=IDevID] {LDevID};
  ...
  \node[key] (LAK) [node distance=1.5cm,below of=IAK] {LAK};
